...
<body>
    ...
    require_once('json_mysql.php'); // required to ensure data being pulled from the database remains up to date.
    ?>
    ...
    <div id="Home-Page-Top"></div>
        ...
        <div class="row p-2 m-0 p-0">
            <div class="col-12 col-sm-12 d-flex justify-content-end" id="icons">
                ...
                <a href="http://localhost/twincities/rss.php">
        ...
        <div class="row mb-3">
            <div class="col-12 col-sm-12 col-md-6 col-lg-6" id="div1">
                <div class="col-12 col-sm-12 d-flex justify-content-center justify-content-sm-start">
                    <img class="img-fluid img-thumbnail" alt="Birmingham" src="https://www.visitbritain.com/sites/default/files/consumer_components_enhanced/highlighted_page/view_over_birmingham_city_centre_at_dusk_vb34156177.jpg">
                </div>
                <?php
        ...
        <div class="row mb-6">
            ...
            <div class="col-sm-12 col-md-6 col-lg-6 mb-6">
                ...
                <div id="images">
                    <div>
                        <?php
                        require_once('flickr.php'); // required to cache the images to flickr database.
                        BirminghamPics();
                        ?>
                    </div>
                </div>
        ...
        <div class="row mb-3">
            <div class="col-12 col-sm-12">           
                <div id="images">   
                    ...
                    if($file != '.' && $file != '..'){
                    echo "<td><img class='m-1 rounded' src='upload/$file' alt='$file' width = 293 height = 293><br>
                      </td>";
                    }
                    }
                    echo"<tr/>";
