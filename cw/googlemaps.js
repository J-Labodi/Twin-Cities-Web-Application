...
Authors:Callum Jones,Connor MacKintosh,Dikshyanta Uprety,Jeno Labodi  - 2022
    googlemaps.js - This displays maps of our twincities to the main page including marker 
*/
// set vairables for each type of poi marker
...
function loadBirmingham() {
    ...
    var Bmarkers = [
        {   // Birmingham airport marker
            ...
            click: "mapsRedirect/BirminghamAirport.html"
        ...
        // Birmingham Electric Cinema marker
        {
            ...
            click: "mapsRedirect/ElectricCinema.html"
        },
        // Birmingham ODEON Broadway Plaza marker
        {
            ...
            click: "mapsRedirect/ODEONBroadwayPlaza.html"
        },
        // Birmingham Cineworld Cinema marker
        {
            ...
            click: "mapsRedirect/BirminghamCineworld.html"
        },
        {
            // thinktank marker
            ...
            click: "mapsRedirect/Thinktank.html"
        },
        //Birmingham Museum & Art Gallery marker
        {
            ...
            click: "mapsRedirect/BirminghamMuseumArtGallery.html"
        },
        // Birmingham Villa Park marker
        {
            ...
            click: "mapsRedirect/VillaPark.html"
        },
        // Birmingham St Andrews stadium marker
        {
            ...
            click: "mapsRedirect/StAndrews.html"
        }
    ];
...
function loadChicago() {
    ...
    var Cmarkers = [
        {   //  MidChicagoway International Airport marker
            ...
            click: "mapsRedirect/MidChigIntAirport.html"
        },
        {   // O''Hare International Airport marker
            ...
            click: "mapsRedirect/OHareIntAirport.html"
        },
        {   // Regal Webster Place marker
            ...
            click: "mapsRedirect/RegalWebsterPlace.html"
        },
        {   // AMC River East 21 marker marker
            ...
            click: "mapsRedirect/AMCRiverEast21.html"
        },
        {   // The Logan Theatre marker
            ...
            click: "mapsRedirect/TheLoganTheatre.html"
        },
        {   // Chicago History Museum marker
            ...
            click: "mapsRedirect/ChicagoHistoryMuseum.html"
        },
        {   // Field Museum marker
            ...
            click: "mapsRedirect/FieldMuseum.html"
        },
        ...
        {   
            ...
            click: "mapsRedirect/UnitedCentre.html"
        }
