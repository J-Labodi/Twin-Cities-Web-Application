<?php
//This file contains all the functions used by index.php
...
function makeXML($num) {
    ...
    $dir = "XML_files\\";   //specifying the directory to store the xml files
...
function xml_to_rss($number) {
    ...
    $dir = 'XML_files\\';               //specifying the exact path to the XML file
    $dir.= $filename;
